...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/controller_avalon_st_adapter_001.v"                            -work avalon_st_adapter_001                                  
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/controller_avalon_st_adapter.v"                                -work avalon_st_adapter                                      
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/controller_uart_0.v"                                           -work uart_0                                                 
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_st_bytes_to_packets.v"                           -work st_bytes_to_packets_0                                  
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_packets_to_master.v"                             -work packets_to_master_0                                    
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/controller_multiplexer_0.sv"                                   -work multiplexer_0                                          
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/motor_controller.sv"                                           -work motor_controller_0                                     
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/controller_counter_0.v"                                        -work counter_0                                              
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L cpu -L read_mstr_internal -L prefetcher_internal -L dispatcher_internal -L fpci_multi -L fpci_combi -L rst_controller -L avalon_st_adapter_001 -L avalon_st_adapter -L irq_mapper -L mm_interconnect_4 -L mm_interconnect_3 -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L nios_0_custom_instruction_master_multi_xconnect -L nios_0_custom_instruction_master_comb_slave_translator0 -L nios_0_custom_instruction_master_comb_xconnect -L nios_0_custom_instruction_master_translator -L vic_0 -L vector_controller_master_0 -L uart_0 -L timer_0 -L sysid_qsys_0 -L st_packets_to_bytes_0 -L st_bytes_to_packets_0 -L spislave_0 -L spim_0 -L pio_2 -L pio_1 -L pio_0 -L packets_to_master_0 -L nios_0 -L multiplexer_0 -L msgdma_0 -L motor_controller_0 -L mm_bridge_0 -L instruction_rom_0 -L imu_spim -L i2c_master_0 -L fpu_0 -L data_ram_1 -L data_ram_0 -L counter_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclone10lp_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclone10lp $TOP_LEVEL_NAME
}
