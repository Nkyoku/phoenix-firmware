...
add wave -noupdate -radix decimal /test/svm/abs_a_sqrt3
add wave -noupdate -radix decimal /test/svm/abs_b
add wave -noupdate -radix decimal /test/svm/t1
add wave -noupdate -radix decimal /test/svm/t2
add wave -noupdate -radix decimal /test/svm/t3_half
add wave -noupdate -radix decimal /test/svm/u0
add wave -noupdate -radix decimal /test/svm/v0
add wave -noupdate -radix decimal /test/svm/w0
...
add wave -noupdate -radix decimal /test/svm/u_out
add wave -noupdate -radix decimal /test/svm/v_out
add wave -noupdate -radix decimal /test/svm/w_out
add wave -noupdate -divider {New Divider}
add wave -noupdate -format Analog-Step -height 128 -max 3000.0 -radix decimal /test/u_out
add wave -noupdate -format Analog-Step -height 128 -max 3000.0 -radix decimal /test/v_out
add wave -noupdate -format Analog-Step -height 128 -max 3000.0 -radix decimal /test/w_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {6355 ns} 0}
